...
<table>
	...
	{
		 %>
<tr>			 <td>ID</td><TD><input type="text" value="<%out.println(rs.getInt(1));%>" readonly></TD></tr>

			<td>Year</td><TD><input type="text" value="<%out.println(rs.getInt(3));%>" readonly></TD></tr>
			<td>Actor</td><TD><input type="text" value="<%out.println(rs.getString(4));%>" readonly></TD></tr>
<%	}
%>
		 </table><br><br><br>
